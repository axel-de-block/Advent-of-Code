...
//            System.out.printf("Window merged to %d-%d\n\n", start, end);
        ...
        List<Long> sortedKeySet = mergedWindows.keySet().stream().toList().stream().sorted().toList();
        for (Long key : sortedKeySet) {
//            System.out.printf("%d-%d -> %d\n", key, mergedWindows.get(key), mergedWindows.get(key) - key + 1);
            counter += mergedWindows.get(key) - key + 1;
        }
